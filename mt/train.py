...
import mt.common.misc
import mt.common.text_vectorize
from mt import preprocess as _pre
from mt.common import load_dataset
from mt.config import get_config as _config
from mt.model import nmt_model
from mt.model import transformer as _transformer
from utils import optimizers as _optimizers
from utils import train_history
from mt.common.misc import check_and_create
...
def _train(transformer, validation_data='False', validation_split=0.0,
    ...
    # 读取数据
    print("加载训练数据...")
    source_sequences_path_train = mt.common.text_vectorize.get_encoded_sequences_path(_config.source_lang,
                                                                                          postfix='_train')
    target_sequences_path_train = mt.common.text_vectorize.get_encoded_sequences_path(_config.target_lang,
                                                                                          postfix='_train')
    ...
    if validation_data == 'True':  # 从文本中加载val_dataset
        print("加载验证数据...")
        source_sequences_path_val = mt.common.text_vectorize.get_encoded_sequences_path(_config.source_lang,
                                                                                            postfix='_val')
        target_sequences_path_val = mt.common.text_vectorize.get_encoded_sequences_path(_config.target_lang,
                                                                                            postfix='_val')
